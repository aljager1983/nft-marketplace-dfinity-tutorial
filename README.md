...
```                                          "<NFT PRINCIPAL ID>
dfx canister call opend listItem '(principal "xub3y-eqaaa-aaaaa-aaawq-cai", 220)'
```
...
```                <NFT PRINCIPAL ID>
dfx canister call xub3y-eqaaa-aaaaa-aaawq-cai transferOwnership '(principal "sbzkb-zqaaa-aaaaa-aaaiq-cai", true)'
```
